...
\begin{frame}{Transductor}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
               \includegraphics[width=\textwidth]{fig/tostadora.jpg}
               \scalebox{0.3}{\url{https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/MAXIMATOR-High-Pressure-Manometer-01a.jpg/1200px-MAXIMATOR-High-Pressure-Manometer-01a.jpg}}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
